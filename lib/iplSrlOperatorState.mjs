/**
 * Desk control for user-facing BetKing SRL matches (`srl_ipl_*`).
...
export function startSrlOperatorMatch(matchId, now = Date.now()) {
...
export function pauseSrlOperatorMatch(matchId, now = Date.now()) {
  const s = getSrlOperatorSession(matchId);
