...
export function parseCricbuzzMatchHtml(html, matchId) {
  ...
  if (bowlingInnings) {
    ...
    const isBowlChase = (bowlingInnings.inningsId ?? 1) > 1;
    if (isBowlChase) {
      liveDetails.chaseRuns = bowlingInnings.runs;
      liveDetails.chaseWickets = bowlingInnings.wickets;
      liveDetails.chaseOvers = overs;
      liveDetails.chaseTeamId = bowlingInnings.teamId;
      liveDetails.chaseTeamName = bowlingInnings.teamName;
    } else {
