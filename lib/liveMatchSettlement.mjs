...
export function evaluateTotalsMarketBet(bet, match) {
  ...
  if (isTeamTotal) {
    ...
    if (inningsScoped) {
    ...
    } else if (bet?.placement_snapshot?.inningsAtPlacement) {
      inn = Number(bet.placement_snapshot.inningsAtPlacement);
      ...
      inn = 2;
    } else if (bat.innings === 2) {
      // Live match is currently in innings 2. Live unscoped team_total belongs to the active 2nd innings chase!
      inn = 2;
    }
