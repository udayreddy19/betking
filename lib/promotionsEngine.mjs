 ...
 *  RETIRED: do not mark COMPLETED or mutate turnover here.
 *  Authoritative path is recordBonusWageringInTx inside settlement.
 */
export async function processBonusWageringProgress() {
  return { updated: false, skipped: 'legacy_disabled' };
}
