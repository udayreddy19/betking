/**
 * Enterprise Authoritative Support Engine — BetKing Sportsbook (lib/supportEngine.mjs)
  ...
  getUserConversations(userId) {
    return Array.from(this.conversations.values())
      ...
      .map((c) => ({
        ...
        internalNotes: [], // Never expose internal notes to customer
      }));
  }

  getConversationById(conversationId, userRole = 'user') {
    const conv = this.conversations.get(conversationId);
    if (!conv) return null;
