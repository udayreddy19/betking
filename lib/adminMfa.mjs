...
/**
 * Admin TOTP (Google Authenticator) is opt-in only.
 * Set ADMIN_MFA_REQUIRED=1 to re-enable enrollment + verification.
 * Production no longer forces authenticator by default.
 */
export function isAdminMfaEnforced() {
  const flag = String(process.env.ADMIN_MFA_REQUIRED || '').toLowerCase();
