/**
 * Enterprise Provider Health Manager — BetKing Sportsbook (lib/providerHealthManager.mjs)
...
const PROVIDER_HEALTH_STORE = new Map([
  ['10cric2026', { id: '10cric2026', name: '10Cric Gateway', priority: 1, status: 'HEALTHY', latencyMs: 45, errorCount: 0, totalRequests: 100, lastPing: Date.now() }],
  ...
  ['cricbuzz', { id: 'cricbuzz', name: 'Cricbuzz API', priority: 3, status: 'HEALTHY', latencyMs: 120, errorCount: 0, totalRequests: 100, lastPing: Date.now() }],
  ['fancode', { id: 'fancode', name: 'FanCode Stream', priority: 4, status: 'HEALTHY', latencyMs: 140, errorCount: 0, totalRequests: 100, lastPing: Date.now() }],
