...
export function createCanonicalMatchState(input) {
  ...
  for (const field of required) {
    if (input[field] === undefined || input[field] === null) {
      // Test / multi-day innings have no fixed ball budget.
      if (field === 'ballsRemaining' && String(input.format || '').toUpperCase() === 'TEST') {
        continue;
      }
  ...
  const state = Object.freeze({
    ...
    team1: Object.freeze({
      ...
      ...(input.team1.rating != null ? { rating: Number(input.team1.rating) } : {}),
      ...(input.team1.fours != null && Number.isFinite(Number(input.team1.fours))
        ? { fours: Number(input.team1.fours) } : {}),
      ...(input.team1.sixes != null && Number.isFinite(Number(input.team1.sixes))
        ? { sixes: Number(input.team1.sixes) } : {}),
    }),
    ...
    team2: Object.freeze({
      ...
      ...(input.team2.rating != null ? { rating: Number(input.team2.rating) } : {}),
      ...(input.team2.fours != null && Number.isFinite(Number(input.team2.fours))
        ? { fours: Number(input.team2.fours) } : {}),
      ...(input.team2.sixes != null && Number.isFinite(Number(input.team2.sixes))
        ? { sixes: Number(input.team2.sixes) } : {}),
    }),
    ...
    ballsRemaining: input.ballsRemaining == null && String(input.format || '').toUpperCase() === 'TEST'
      ? null
      : Number(input.ballsRemaining),
    ...
    toss: input.toss ? Object.freeze({ ...input.toss }) : null,
    ...
    providerTimestampFallback: Boolean(input.providerTimestampFallback),
    providerSequence: input.providerSequence != null ? Number(input.providerSequence) : null,
    eventTimestamp: input.eventTimestamp != null ? Number(input.eventTimestamp) : null,
