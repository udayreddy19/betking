...
let depositSchemaReady = null;
export async function ensureDepositSchema() {
  if (!depositSchemaReady) {
    depositSchemaReady = (async () => {
      try {
        await query(`
          ...
          ALTER TABLE deposits ADD COLUMN IF NOT EXISTS provider VARCHAR(32) DEFAULT 'CASHFREE';
          ...
          ALTER TABLE deposits ADD COLUMN IF NOT EXISTS razorpay_order_id VARCHAR(128);
          ALTER TABLE deposits ADD COLUMN IF NOT EXISTS refunded_amount NUMERIC(14,2) DEFAULT 0.00;
        `);
      } catch (err) {
