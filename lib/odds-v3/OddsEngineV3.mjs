...
export function generate(matchState, config = {}) {
  ...
  const sport = String(matchState?.sport || 'CRICKET').toUpperCase();
  if (sport && sport !== 'CRICKET' && !sport.includes('CRICKET')) {
  ...
  const protectedMarkets = applyBookIntegrity(validMarkets);
