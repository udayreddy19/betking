...
export const DEFAULT_RISK_CONFIG = Object.freeze({
  // On by default — shorten overloaded selections (set ODDS_RISK_SHADING_ENABLED=false to disable)
  enabled: process.env.ODDS_RISK_SHADING_ENABLED !== 'false',
  sensitivityGamma: 0.08,
  marketCapacity: 50000,
