...
export const featuredLeagues = [
  ...
  { id: 'sl-ind', name: 'Sri Lanka vs India', sport: 'cricket', icon: 'flame', matchLeagues: ['Sri Lanka vs India', 'Sri Lanka vs India, 2026', 'India tour of Sri Lanka', 'India tour of Sri Lanka, 2026', 'India tour of Sri Lanka 2026', 'Test Series Sri Lanka vs. India', 'Sri Lanka XI vs India'] },
  ...
  { id: 'tnpl', name: 'Tamil Nadu Premier League', sport: 'cricket', icon: 'flame', matchLeagues: ['Tamil Nadu Premier League', 'Tamil Nadu Premier League 2026', 'TNPL', 'TNPL 2026'] },
...
export const promotions = [
  ...
  },
  {
    ...
    bonusAmount: 1000,
    terms: [
      'Cashback calculated on net sports losses for the prior week.',
      'Credited every Monday up to ₹10,000 with code CASHBACK10.',
      'Cashback cannot be withdrawn, transferred, or exchanged outside wallet rules.',
      'OddsYra may modify, suspend, or withdraw the offer.',
    ],
  },
  {
    id: 'p3',
    ...
    bonusAmount: 2000,
    terms: [
      '100% casino match up to ₹70,000 with code CASINO100.',
      '50 Free Spins on Aviator included for eligible claims.',
      'Bonus and spins subject to game contribution and wagering rules.',
      'OddsYra may modify, suspend, or withdraw the offer.',
    ],
  },
];
