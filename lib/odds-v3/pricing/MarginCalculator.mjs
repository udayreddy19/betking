...
export const DEFAULT_MARGIN_CONFIG = Object.freeze({
  ...
  // Higher live totals margin — soft ~2.2 Overs were printing for ladder bettors
  liveTeamTotalOverround: 0.08,
  liveMatchTotalOverround: 0.08,
});

/** Live team/match total Over must not be sold as a soft coin-flip. */
export const MAX_LIVE_TOTAL_OVER_ODDS = 1.85;
