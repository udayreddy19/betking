...
export const MARKET_SETTLEMENT_REGISTRY = {
  ...
  // 1b. Toss family (settles when toss/decision known — not match complete)
  TOSS_WINNER: {
    pattern: /^toss_winner$/i,
    grader: 'tossWinnerMarket',
    boundary: 'EVENT_COMPLETE',
  },
  TOSS_AND_BAT: {
    pattern: /^toss_and_bat$/i,
    grader: 'tossElectionMarket',
    boundary: 'EVENT_COMPLETE',
  },
  TOSS_AND_BOWL: {
    pattern: /^toss_and_bowl$/i,
    grader: 'tossElectionMarket',
    boundary: 'EVENT_COMPLETE',
  },
  TEAM_BAT_FIRST: {
    pattern: /^team_bat_first$/i,
    grader: 'teamBatFirstMarket',
    boundary: 'EVENT_COMPLETE',
  },
  ...
  SOCCER_HT_RESULT: {
    pattern: /^ht_result$/i,
    grader: 'soccerHalfTimeMarket',
    boundary: 'HALF_TIME',
  },
  SOCCER_CORRECT_SCORE: {
    pattern: /^correct_score$/i,
    grader: 'soccerCorrectScoreMarket',
    boundary: 'MATCH_COMPLETE',
  },
  SOCCER_FIRST_TO_SCORE: {
    pattern: /^first_to_score$/i,
    grader: 'firstToScoreMarket',
    boundary: 'FIRST_GOAL',
  },
  RUN_LINE: {
    pattern: /^run_line$/i,
  ...
  TOTAL_GOALS: {
    pattern: /^total_goals$/i,
    grader: 'scoreTotalMarket',
    boundary: 'MATCH_COMPLETE',
  },
  FIRST_HALF_WINNER: {
    pattern: /^first_half_winner$/i,
    grader: 'halfWinnerMarket',
    boundary: 'HALF_TIME',
  },
  FIRST_HALF_TOTAL: {
    pattern: /^first_half_total$/i,
    grader: 'halfTotalMarket',
    boundary: 'HALF_TIME',
  },
  WINNING_MARGIN: {
    pattern: /^winning_margin$/i,
    grader: 'winningMarginMarket',
    boundary: 'MATCH_COMPLETE',
  },
  CORRECT_SET_SCORE: {
    pattern: /^correct_set_score$/i,
    grader: 'correctSetScoreMarket',
    boundary: 'MATCH_COMPLETE',
  },
};
