...
function envDefaults() {
  ...
  return {
    ...
    /** When friends bet cash, referrer earns this fraction of stake (default 5%). */
    ...
    /** 0 = no daily cap. */
    playCommissionDailyCap: Math.max(0, Number(process.env.REFERRAL_PLAY_COMMISSION_DAILY_CAP || '0') || 0),
  };
}
