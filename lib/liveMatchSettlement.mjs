...
import { detectCricketMatchFormat, getMatchMaxOvers, oversToBallsForMatch } from '../src/utils/cricketFormat.js';
...
function isMatchFinal(match) {
  ...
  // Multi-day / County / Test: never infer "final" from wall-clock age (matches last days).
