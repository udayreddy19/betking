...
export function generateExtendedPlayerMarkets(state, validation = {}, marginConfig = {}) {
  ...
  // CRITICAL BOOKMAKER PROTECTION:
  // If match has progressed beyond 18 balls and batter has 0 runs & 0 balls faced recorded,
  // feed data is missing live batsman statistics. Do NOT generate open milestone markets.
  if (ballsCompleted > 18 && b1Runs === 0 && b1Balls === 0) {
    return [];
  }
