...
export function enrichLivePlayersFromScorecard(liveDetails = {}, scorecardInnings = []) {
  ...
  // Always enrich / sync live batter stats (runs, balls, fours, sixes) from scorecard
  const matchBatter1 = (currentInnings.batters || []).find(
  ...
  const matchBatter2 = (currentInnings.batters || []).find(
