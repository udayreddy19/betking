...
import { resolveSettlementGrader } from './marketSettlementRegistry.mjs';
...
export const MARKET_SETTLEMENT_CONTRACTS = [
  ...
  {
    marketPattern: /^toss_winner$/i,
    name: 'Toss Winner',
    sport: 'cricket',
    settlementTiming: 'IN_PLAY',
    resolver: 'tossWinnerMarket',
    requiredEvidence: ['match.toss.winner'],
    voidPolicy: 'VOID_IF_ABANDONED_OR_NO_RESULT',
    supported: true,
  },
  {
    marketPattern: /^toss_and_bat$/i,
    name: 'Toss Winner Bats',
    sport: 'cricket',
    settlementTiming: 'IN_PLAY',
    resolver: 'tossElectionMarket',
    requiredEvidence: ['match.toss.decision'],
    voidPolicy: 'VOID_IF_ABANDONED_OR_NO_RESULT',
    supported: true,
  },
  {
    marketPattern: /^toss_and_bowl$/i,
    name: 'Toss Winner Bowls',
    sport: 'cricket',
    settlementTiming: 'IN_PLAY',
    resolver: 'tossElectionMarket',
    requiredEvidence: ['match.toss.decision'],
  ...
  {
    marketPattern: /^team_bat_first$/i,
    name: 'Team to Bat First',
    sport: 'cricket',
    settlementTiming: 'IN_PLAY',
    resolver: 'teamBatFirstMarket',
    requiredEvidence: ['match.toss.winner', 'match.toss.decision'],
    voidPolicy: 'VOID_IF_ABANDONED_OR_NO_RESULT',
    supported: true,
  },
  {
  ...
  // 10. Extended Other-Sports Markets (v4.9)
  {
    marketPattern: /^ht_result$/i,
    name: 'Half-Time Result',
    sport: 'soccer',
    settlementTiming: 'IN_PLAY',
    resolver: 'soccerHalfTimeMarket',
    requiredEvidence: ['liveDetails.htScore1', 'liveDetails.htScore2'],
    voidPolicy: 'VOID_IF_HT_SCORES_MISSING',
    supported: true,
  },
  {
    marketPattern: /^correct_score$/i,
    name: 'Correct Score',
    sport: 'soccer',
    settlementTiming: 'MATCH_COMPLETE',
    resolver: 'soccerCorrectScoreMarket',
    requiredEvidence: ['match.score1', 'match.score2'],
    voidPolicy: 'VOID_IF_MATCH_CANCELLED',
    supported: true,
  },
  {
    marketPattern: /^first_to_score$/i,
    name: 'First Team to Score',
    sport: 'soccer',
    settlementTiming: 'IN_PLAY',
    resolver: 'firstToScoreMarket',
    requiredEvidence: ['liveDetails.firstGoalTeam'],
    voidPolicy: 'VOID_IF_FIRST_GOAL_EVIDENCE_MISSING',
    supported: true,
  },
  {
    marketPattern: /^run_line$/i,
    name: 'Baseball Run Line',
    sport: 'baseball',
    settlementTiming: 'MATCH_COMPLETE',
    resolver: 'scoreSpreadMarket',
    requiredEvidence: ['match.score1', 'match.score2'],
  ...
  {
    marketPattern: /^total_runs$/i,
    name: 'Baseball Total Runs',
    sport: 'baseball',
    settlementTiming: 'MATCH_COMPLETE',
    resolver: 'scoreTotalMarket',
    requiredEvidence: ['match.score1', 'match.score2'],
  ...
  {
    marketPattern: /^puck_line$/i,
    name: 'Ice Hockey Puck Line',
    sport: 'ice-hockey',
    settlementTiming: 'MATCH_COMPLETE',
    resolver: 'scoreSpreadMarket',
    requiredEvidence: ['match.score1', 'match.score2'],
  ...
  {
    marketPattern: /^total_goals$/i,
    name: 'Ice Hockey Total Goals',
    sport: 'ice-hockey',
    settlementTiming: 'MATCH_COMPLETE',
    resolver: 'scoreTotalMarket',
    requiredEvidence: ['match.score1', 'match.score2'],
  ...
  {
    marketPattern: /^first_half_winner$/i,
    name: '1st Half Winner',
    sport: 'all',
    settlementTiming: 'IN_PLAY',
    resolver: 'halfWinnerMarket',
    requiredEvidence: ['liveDetails.htScore1', 'liveDetails.htScore2'],
    voidPolicy: 'VOID_IF_HT_SCORES_MISSING',
    supported: true,
  },
  {
    marketPattern: /^first_half_total$/i,
    name: '1st Half Total Points',
    sport: 'all',
    settlementTiming: 'IN_PLAY',
    resolver: 'halfTotalMarket',
    requiredEvidence: ['liveDetails.htScore1', 'liveDetails.htScore2'],
    voidPolicy: 'VOID_IF_HT_SCORES_MISSING',
    supported: true,
  },
  {
    marketPattern: /^winning_margin$/i,
    name: 'Winning Margin',
    sport: 'all',
    settlementTiming: 'MATCH_COMPLETE',
    resolver: 'winningMarginMarket',
    requiredEvidence: ['match.score1', 'match.score2'],
    voidPolicy: 'VOID_IF_MATCH_CANCELLED',
    supported: true,
  },
  {
    marketPattern: /^correct_set_score$/i,
    name: 'Correct Score in Sets',
    sport: 'tennis',
    settlementTiming: 'MATCH_COMPLETE',
    resolver: 'correctSetScoreMarket',
    requiredEvidence: ['liveDetails.sets1', 'liveDetails.sets2'],
    voidPolicy: 'VOID_IF_SET_SCORES_MISSING',
    supported: true,
  },
...
export function validateMarketSettlementCompatibility(market) {
  ...
  const liveGrader = resolveSettlementGrader(market.marketId);
  if (!liveGrader) {
    return {
      compatible: false,
      reason: `ORPHAN_GRADER: Contract for '${market.marketId}' has no registry grader`,
      resolver: contract.resolver,
      missingEvidence: ['registry_grader'],
      supported: false,
    };
  }
  if (liveGrader !== contract.resolver) {
    return {
      compatible: false,
      reason: `RESOLVER_MISMATCH: contract=${contract.resolver} registry=${liveGrader}`,
      resolver: contract.resolver,
      missingEvidence: ['resolver_parity'],
      supported: false,
    };
  }
