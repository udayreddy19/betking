...
router.get('/reports', requirePermission('admin'), async (req, res) => {
  try {
...
router.get('/retention', requirePermission('admin'), async (req, res) => {
  try {
...
router.get('/funnel', requirePermission('admin'), async (req, res) => {
  try {
