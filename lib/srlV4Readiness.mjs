...
export function scoreSrlV4Readiness() {
  ...
  checks.v4Version47 = /^4\.(7|8|9)/.test(String(V4_ENGINE_VERSION || ''));
  checks.v4Version48 = /^4\.(8|9)/.test(String(V4_ENGINE_VERSION || ''));
  checks.v4Version49 = /^4\.9/.test(String(V4_ENGINE_VERSION || ''));
  ...
  if (checks.v4Version47) engine += 1;
  if (checks.v4Version48) engine += 1;
