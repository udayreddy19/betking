...
export function handleUserSupportQuery(queryText = '', userId = 'demo@betking.com') {
  ...
  let typingText = 'BetKing Assistant is processing...';
  let actions = [];
  ...
  switch (intent) {
    ...
    case 'RESPONSIBLE_GAMING': {
      ...
      response = `BetKing promotes safe, responsible gaming. You can set custom daily deposit limits, loss limits, or activate self-exclusion anytime in your Profile.`;
      actions = [
    ...
    case 'GREETING': {
      category = 'GENERAL';
      typingText = 'BetKing Assistant is typing...';
