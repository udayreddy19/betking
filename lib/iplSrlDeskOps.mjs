...
export const SRL_DANGEROUS_ACTIONS = {
  ...
  unlock_toss: { cooldownMs: 4000, senior: true, requireNote: true },
  force_winner: { cooldownMs: 8000, senior: true, requireNote: true },
};
...
export function getSrlDeskCapabilities(role = 'SUPER_ADMIN') {
  ...
  return {
    ...
    canUnlockToss: senior,
    canForceWinner: senior,
    senior,
  };
}
...
export function assertSrlCapability(role, capability) {
  ...
  const map = {
    ...
    unlock_toss: caps.canUnlockToss,
    force_winner: caps.canForceWinner,
  };
