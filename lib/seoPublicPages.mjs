...
export const SEO_PUBLIC_PAGES = {
  ...
  '/live-cricket-betting': {
    ...
    paragraphs: [
      ...
      'How to start: create an account on Register, complete KYC when prompted so withdrawals stay smooth, deposit via UPI, open Sports or Live Betting, pick a cricket market, set your stake, and confirm. Prefer simulated cricket with a full league calendar? Open OddsYra SRL for fixtures, points, and desk-run markets.',
      ...
      'Need help with a deposit, withdrawal, or market that will not open? Visit Help. Legal documents live under Terms and Privacy.',
    ],
  },
  '/srl': {
  ...
  '/vip': {
    ...
    paragraphs: [
      ...
      'New to OddsYra? Register, explore Sports, and grow into VIP over time. Safer play tools remain available on Responsible Gaming for every tier.',
    ],
  },
  '/help': {
