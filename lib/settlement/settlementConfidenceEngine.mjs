...
export const MARKET_FINALITY_POLICIES = {
  TOSS: { requiredGraceSeconds: 0, requireMatchFinal: false, requireEventFinal: true },
  NEXT_BALL: { requiredGraceSeconds: 0, requireMatchFinal: false, requireEventFinal: true },
  OVER_TOTAL: { requiredGraceSeconds: 0, requireMatchFinal: false, requireEventFinal: true },
  WICKET_IN_OVER: { requiredGraceSeconds: 0, requireMatchFinal: false, requireEventFinal: true },
  PLAYER_RUNS: { requiredGraceSeconds: 0, requireMatchFinal: false, requireEventFinal: true },
  MATCH_WINNER: { requiredGraceSeconds: 30, requireMatchFinal: true, requireEventFinal: false },
  ACCUMULATOR: { requiredGraceSeconds: 0, requireMatchFinal: false, requireEventFinal: true },
  GENERIC: { requiredGraceSeconds: 0, requireMatchFinal: false, requireEventFinal: true },
};
...
export function resolveMarketFinalityPolicy(marketTypeOrId = '') {
  ...
  if (norm.includes('WICKET')) return MARKET_FINALITY_POLICIES.WICKET_IN_OVER;
...
export function evaluateSettlementConfidence({
  ...
  const stale = !isFinalMatch && ageSeconds > cfg.settlementDataMaxAgeSeconds && cfg.settlementDataMaxAgeSeconds > 0;
