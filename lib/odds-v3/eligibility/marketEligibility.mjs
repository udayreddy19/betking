 ...
 * Early cuts stop late-window laddering:
 *   0–10 disappears from the 7th over (after 6 overs done)
 *   0–15 disappears from the 10th over (after 9 overs done)
 * Other windows close at the natural boundary.
 *
...
export function milestoneBetCutoffBalls(targetOvers, ballsPerOver = 6) {
  ...
  if (target === 10) return 6 * bp;
  if (target === 15) return 9 * bp;
  if (Number.isFinite(target) && target > 0) return target * bp;
