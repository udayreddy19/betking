...
import { OSV4_ENGINE_VERSION, OSV4_MARGIN_CONFIG } from './pricing/MarginPolicy.mjs';
import { isFinishedMatch, teamName } from './state/readMatchState.mjs';
import { applyBookIntegrity, bookPoints } from './book/helpers.mjs';
import { tightenOsV4Markets } from './book/houseProtect.mjs';
...
export { OSV4_ENGINE_VERSION, OSV4_MARGIN_CONFIG };
...
export function generate(match, config = {}) {
  ...
  const margins = { ...OSV4_MARGIN_CONFIG, ...(config.margins || {}) };
  ...
  const protectedMarkets = guarded.markets;
