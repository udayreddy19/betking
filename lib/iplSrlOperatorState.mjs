...
export function generateDefaultSrlMicroMarkets(matchId, currentMatch = null) {
  ...
  const striker = ld.batsman || 'Striker';
  ...
  return [
    {
      ...
      subtitle: `Will ${nextOverNum}.0 over yield over or under 9.5 runs?`,
      line: 9.5,
      status: 'OPEN',
      holdPercent: 0.08,
      outcomes: [
        { id: 'over', label: `Over 9.5 Runs`, odds: 1.88, liability: 14500 },
        { id: 'under', label: `Under 9.5 Runs`, odds: 1.88, liability: 18200 },
      ],
    },
    {
      ...
      holdPercent: 0.07,
      outcomes: [
        { id: 'yes', label: 'Yes (Boundary Scored)', odds: 1.62, liability: 28400 },
        { id: 'no', label: 'No Boundaries', odds: 2.24, liability: 15600 },
      ],
    },
    {
      ...
      holdPercent: 0.10,
      outcomes: [
        { id: 'caught', label: 'Caught / Behind', odds: 2.10, liability: 12000 },
        { id: 'bowled', label: 'Bowled / Stumped', odds: 3.25, liability: 9500 },
        { id: 'lbw', label: 'LBW (Leg Before)', odds: 4.40, liability: 6200 },
        { id: 'run_out', label: 'Run Out / Direct Hit', odds: 7.50, liability: 3800 },
      ],
    },
    {
      ...
      holdPercent: 0.08,
      outcomes: [
        { id: 'yes', label: 'Yes (50+ Runs)', odds: 2.05, liability: 19800 },
        { id: 'no', label: 'No (Under 50)', odds: 1.76, liability: 21500 },
      ],
    },
  ];
}
