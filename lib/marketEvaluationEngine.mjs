...
export function evaluateMarketAgainstMatchState(market = {}, matchState = {}) {
  ...
  // Never treat score2 alone as chase — away batting first populates score2 in innings 1
  const isSecondInnings = currentInningsNum >= 2
    || Number(ld.chaseRuns) > 0
    || Number(ld.chaseWickets) > 0
    || (ld.chaseTeamName && Number(ld.chaseRuns) > 0);
