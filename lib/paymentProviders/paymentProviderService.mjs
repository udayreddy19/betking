      ...
      try {
        await client.query(
          `INSERT INTO audit_logs (
           ...
           VALUES ($1, 'PAYMENT_GATEWAY_CONFIG_CHANGED', 'PAYMENT_GATEWAY', $2, $3, $4, NOW())`,
          [
            `audit_gw_${Date.now()}_${Math.random().toString(36).slice(2, 6)}`,
            providerUpper,
            adminId,
            JSON.stringify({
              previous: {
        ...
        logger.warn('[PaymentProviderService] Non-fatal audit log write warning:', auditErr);
      }
