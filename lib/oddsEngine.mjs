/**
 * @deprecated Do not use for live sportsbook pricing, placement, or settlement.
 * Live odds must come from OddsEngineV3 (`lib/odds-v3` via `lib/v3MatchOdds.mjs`).
 * This module remains only for historical/non-live helpers and must not be imported
 * by betPlacementEngine, betSettlementEngine, cashoutEngine, or pricingEngine.
 */
