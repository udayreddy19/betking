...
export function isAllowedSupportAttachment(fileName, fileType) {
  ...
  // Common image extensions browsers may report oddly
  return ['jpg', 'jpeg', 'png', 'gif', 'webp', 'heic', 'heif', 'bmp', 'tif', 'tiff', 'svg', 'avif'].includes(ext);
}
...
export async function linkAttachmentsToMessage({ attachmentIds = [], messageId, conversationId } = {}) {
