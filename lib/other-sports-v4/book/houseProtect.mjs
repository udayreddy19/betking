...
export function tightenOsV4Markets(markets = [], marginConfig = OSV4_MARGIN_CONFIG) {
  const maxSel = Number(marginConfig.maxSelectionOdds) || 3.5;
  const maxOver = Number(marginConfig.maxOverOdds) || 1.35;
  const maxYes = Number(marginConfig.maxYesOdds) || 1.85;
