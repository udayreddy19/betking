...
export const FiCrown = withAnimatedIcon(ShieldCheckIcon);
export const FiUserCheck = withAnimatedIcon(UserIcon);
export const FiCalendar = withAnimatedIcon(ClockIcon);
export const FiMinus = withAnimatedIcon(XIcon);
export const FiPhoneCall = withAnimatedIcon(MessageCircleIcon);
export const FiMessageSquare = withAnimatedIcon(MessageCircleIcon);
