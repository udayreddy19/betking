...
import { inferWallClockMatchFinal, isFeedStillLive, inferScoreSportStaleLiveFinal } from './settlement/wallClockFinality.mjs';
...
export function resolveLiveMatchWinner(match) {
  ...
  if (isCricketSettlementSport(match) && firstRuns > 0 && (chaseRuns > 0 || ld.chaseWickets != null)) {
