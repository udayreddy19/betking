...
async function dispatch(entry) {
  ...
  switch (handler) {
    ...
    case 'odds-engine-v4': {
      const { testOddsEngineV4 } = await import('./tests/oddsEngineTest.mjs');
      return testOddsEngineV4();
    }
    case 'other-sports-engine-v4': {
      const { testOtherSportsEngineV4 } = await import('./tests/oddsEngineTest.mjs');
      return testOtherSportsEngineV4();
    }
    case 'razorpay': {
