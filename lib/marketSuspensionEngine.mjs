...
export class MarketSuspensionEngine {
  ...
  async getActiveCauses(marketId) {
    ...
    try {
      ...
      // Fail closed — unknown suspension status must block placement.
      console.warn('[MarketSuspension] getActiveCauses failed (fail-closed):', err.message);
      return [{
        reason: 'SUSPENSION_STATUS_UNKNOWN',
        source: 'SYSTEM',
        actor: null,
