...
export function startBackgroundWorkers() {
  ...
  console.log('✅ Background Workers Active: Outbox (2s), Live aggregator (15s), Settlement Recovery (30s), Spin grant expiry (30s), Support SLA (300s), KYC Reminder (120s), Reconciliation (300s), Ops Alerts (60s), Notifications (15s), API Explorer health (60s), Resettle scan (6h), Payments digest, Backups (5m), SRL Desk Ops (15s), SRL Launch Broadcast (20s)');
}
