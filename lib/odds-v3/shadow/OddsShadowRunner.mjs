...
/**
 * Runs V3 snapshot generator and logs comparison metrics against V2 snapshot.
 * 
 * @param {Object} matchData - Raw or normalized match data
 * @param {Object|null} v2Snapshot - Optional V2 snapshot to compare against
 * @returns {{ v3Snapshot: Object, shadowComparison: Object[] }}
 */
export function runShadowComparison(matchData, v2Snapshot = null) {
  let v3Snapshot = null;
