...
export function splitSettlementWinCredits(bet, payout) {
  ...
  const returnsStake = Boolean(bet.returns_stake);

  // If Free Bet or promotion without stake return: credit profit only to cash
  if (fundSource === 'freebet' || (!returnsStake && fundSource === 'bonus')) {
