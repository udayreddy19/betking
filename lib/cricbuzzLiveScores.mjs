...
function buildLiveDetails(info, matchScore, matchState = 'pre', match = null) {
  ...
  const team1Latest = latestTeamInnings(allInnings.filter((inn) => matchTeam(inn.teamName, team1Name, team1SName)));
  const team2Latest = latestTeamInnings(allInnings.filter((inn) => matchTeam(inn.teamName, team2Name, team2SName)));
