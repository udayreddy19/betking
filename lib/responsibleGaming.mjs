/**
 * Responsible gaming: cooling-off / self-exclusion.
 * Deposit, stake, and loss amount limits are player preferences for display /
 * future hard enforcement — they are NOT hard-blocked in gameplay today.
 * Do not market them as hard limits until validateDepositAttempt /
 * validateBetPlacementAttempt enforce them.
 */
